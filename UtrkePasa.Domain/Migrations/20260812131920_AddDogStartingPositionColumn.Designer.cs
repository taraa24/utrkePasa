...
namespace UtrkePasa.Domain.Migrations
{
    ...
    [Migration("20260812131920_AddDogStartingPositionColumn")]
    partial class AddDogStartingPositionColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UtrkePasa.Domain.Entities.Race", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("dog_Starting_Position")
                        .IsRequired()
                        .HasColumnType("text[]");
